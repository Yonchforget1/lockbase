...
BEGIN
  ...
  -- Camry
  INSERT INTO public.vehicle_models (manufacturer_id, name, slug) VALUES (mfr_id, 'Camry', 'camry') RETURNING id INTO model_id;
  ...
  -- Corolla
  INSERT INTO public.vehicle_models (manufacturer_id, name, slug) VALUES (mfr_id, 'Corolla', 'corolla') RETURNING id INTO model_id;
  ...
  -- RAV4
  INSERT INTO public.vehicle_models (manufacturer_id, name, slug) VALUES (mfr_id, 'RAV4', 'rav4') RETURNING id INTO model_id;
  INSERT INTO public.vehicle_years (model_id, year_start, year_end) VALUES (model_id, 2019, 2024) RETURNING id INTO year_id;
  INSERT INTO public.automotive_keys (year_id, manufacturer_id, model_name, key_blank, transponder_type, chip_type, remote_frequency, key_type, fcc_id, programming_notes, obd_programmable, year_start, year_end)
  ...
  -- Tacoma
  INSERT INTO public.vehicle_models (manufacturer_id, name, slug) VALUES (mfr_id, 'Tacoma', 'tacoma') RETURNING id INTO model_id;
  ...
  -- Highlander
  INSERT INTO public.vehicle_models (manufacturer_id, name, slug) VALUES (mfr_id, 'Highlander', 'highlander') RETURNING id INTO model_id;
